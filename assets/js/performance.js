function startSocket() {
    ...
    //         //stt1 데이터 출력
    //         const boardData3 = JSON.parse(json.data);

    //         //요청건수 출력
    //         const requestTotalSt3 = boardData3["bona-stt3"].request_number;
    //         document.querySelector(".request-data").innerHTML = requestTotalStt1;

    //         //성공률 출력 - 도넛형 차트
    //         const successNumStt3 = boardData3["bona-stt3"].success;
    //         const failPerNumStt3 = boardData3["bona-stt3"].fail;
    //         let bunmo = (successNumStt3 + failPerNumStt3) ? (successNumStt3 + failPerNumStt3) : 1;

    //         const successPerStt3 = (boardData3["bona-stt3"].success / bunmo * 100).toFixed(0);
    //         const failPerStt3 = (boardData3["bona-stt3"].fail / bunmo * 100).toFixed(0);
    ...
    //         //총 음성길이 출력
    //         const audioLengthStt3 = boardData3["bona-stt1"].audio_len / 60;
    //         document.querySelector(".length-data").innerHTML = audioLengthStt3.toFixed(1);

    //         //평균처리 속도 출력
    //         const averageSpeedStt3 = boardData3["bona-stt1"].average_speed;
    //         document.querySelector(".speed-data").innerHTML = averageSpeedStt3.toFixed(1); //소수점 첫째자리까지

    //         //채널상태 - 전체(도넛형 차트)
    //         const totalCh = boardData3["bona-stt3"].channels.total;
    //         const useCh = boardData3["bona-stt3"].channels.running;
    //         const useChPer = boardData3["bona-stt3"].channels.running / 100;
    ...
    //         //채널상태 - 서버별(누적형 막대차트)
    //         const restTotalStt3 = boardData3["bona-stt1"].channels.rest.total;
    //         const grpcTotalStt3 = boardData3["bona-stt1"].channels.grpc.total;
    //         const grpcStreamTotalStt3 = boardData3["bona-stt1"].channels.grpc_stream.total;

    //         const restRunningStt3 = boardData3["bona-stt1"].channels.rest.running;
    //         const grpcRunningStt3 = boardData3["bona-stt1"].channels.grpc.running;
    //         const grpcStreamRunningStt3 = boardData3["bona-stt1"].channels.grpc_stream.running;
