...
//excel 저장 비활성화
const listContent = document.querySelector('#systemGrid td');
...
$(function () {
        ...
        $('.search-btn').on('click', function () {
            ...
            if (sixAgoDate <= eDataTrim) {
                ...
                if (systemType == "systems") {
                    ...
                    $.ajax({
                        url: `http://${json.urls}/monitor/static/resources/systems?time=${timeType}&hostname=${serverName}&start_date=${startDate}&end_date=${endDate}`,
                        headers: { Authorization: "Bearer " + sessionStorage.getItem("Bearer") },
                        method: "GET",
                        dataType: "JSON",
                        success: function (json) {
                    ...
                    function networks(networkCnames) {
                        $("#systemGrid").jqGrid({
                            url: `http://${json.urls}/monitor/static/resources/networks?time=${timeType}&hostname=${serverName}&start_date=${startDate}&end_date=${endDate}`,
                            loadBeforeSend: function (jqXHR) {
                                jqXHR.setRequestHeader("Authorization", 'Bearer ' + sessionStorage.getItem("Bearer"));
                            },
                            datatype: "json",
                    ...
                    function disks(diskCnames) {
                        $("#systemGrid").jqGrid({
                            url: `http://${json.urls}/monitor/static/resources/disks?time=${timeType}&hostname=${serverName}&start_date=${startDate}&end_date=${endDate}`,
                            loadBeforeSend: function (jqXHR) {
                                jqXHR.setRequestHeader("Authorization", 'Bearer ' + sessionStorage.getItem("Bearer"));
                            },
                            datatype: "json",
                    ...
                    function channels(channelCnames) {
                        ...
                        $("#systemGrid").jqGrid({
                            url: `http://${json.urls}/monitor/static/resources/channels?time=${timeType}&hostname=${serverName}&start_date=${startDate}&end_date=${endDate}`,
                            loadBeforeSend: function (jqXHR) {
                                jqXHR.setRequestHeader("Authorization", 'Bearer ' + sessionStorage.getItem("Bearer"));
                            },
                            datatype: "json",
    ...
    $('.execl-btn').on('click', function () {
        $.getJSON("../../config/config.json", function (json) {
            ...
            $.ajax({
                url: `http://${json.urls}/monitor/static/resources/${systemType}?time=${timeType}&hostname=${serverName}&start_date=${startDate}&end_date=${endDate}`,
                headers: { Authorization: "Bearer " + sessionStorage.getItem("Bearer") },
