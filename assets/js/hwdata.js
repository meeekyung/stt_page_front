function startSocket2() {
    ...
    socket2.onmessage = function (json) {
        ...
        if (hardwareData == "bona-lbmon1a") {
            console.log('bona-lbmon1a가 계속 출력되어야함');
            onSet();
        ...
        else if (hardwareData == "bona-lbmon1b") {
            console.log('bona-lbmon1b가 계속 출력되어야함');
            onSet();
        ...
        else if (hardwareData == "bona-stt1") {
            console.log('bona-stt1가 계속 출력되어야함');
            onSet();
        ...
        else if (hardwareData == "bona-stt2") {
            console.log('bona-stt2가 계속 출력되어야함');
            onSet();
        ...
        else if (hwName == "bona-lbmon1a") {
                console.log("hardware-status 최초 출력");
                onSet();
        ...
        $(document).off('click', '#hw0').on('click', '#hw0', function (e) {
            e.preventDefault();
            hardwareData = "bona-lbmon1a";
        });

        //#hw1탭 클릭 시 bona-lbmon1b 데이터 출력
        $(document).off('click', '#hw1').on('click', '#hw1', function (e) {
            e.preventDefault();
            hardwareData = "bona-lbmon1b";
        });

        //#hw2탭 클릭 시 bona-stt1 데이터 출력
        $(document).off('click', '#hw2').on('click', '#hw2', function (e) {
            e.preventDefault();
            hardwareData = "bona-stt1";
        });

        //#hw3탭 클릭 시 bona-stt2 데이터 출력
        $(document).off('click', '#hw3').on('click', '#hw3', function (e) {
            e.preventDefault();
